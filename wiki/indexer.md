...
| `indexer/git_snapshot.py::GitSnapshot.detach_snapshot_leases` | method |  |
| `indexer/git_snapshot.py::GitSnapshot.release_snapshot_leases` | method |  |
...
| `indexer/git_snapshot.py::GitSnapshot._active_snapshot_leases` | method |  |
...
| `indexer/git_snapshot.py::GitSnapshot._begin_snapshot_lease` | method |  |
...
| `indexer/repository_index.py::BranchReconcileReport` | class |  |
| `indexer/repository_index.py::_Head` | class |  |
| `indexer/repository_index.py::_SnapshotRef` | class |  |
...
| `indexer/repository_index.py::RepositoryIndex.reconcile_branches` | method | Remove index scopes that are no longer active for a repository. |
| `indexer/repository_index.py::RepositoryIndex._flatten_snapshot` | method |  |
...
| `indexer/repository_index.py::read_symbols` | function |  |
| `indexer/repository_index.py::RepositoryIndex.files` | method | Return source paths visible from the current branch head. |
| `indexer/repository_index.py::RepositoryIndex._read_relation_snapshot` | method |  |
...
| `indexer/repository_index.py::read_trace` | function |  |
...
| `indexer/repository_index.py::RepositoryIndex._select_snapshot_base` | method |  |
| `indexer/repository_index.py::RepositoryIndex._read_snapshot` | method |  |
| `indexer/repository_index.py::RepositoryIndex._read_snapshot_by_id` | method |  |
| `indexer/repository_index.py::RepositoryIndex._snapshot_candidates` | method |  |
...
| `indexer/repository_index.py::RepositoryIndex._document_count` | method |  |
...
| `indexer/repository_index.py::RepositoryIndex._insert_artifact_records` | method |  |
| `indexer/repository_index.py::RepositoryIndex._ensure_relation_cache` | method |  |
| `indexer/repository_index.py::RepositoryIndex._relation_rows` | method |  |
...
| `indexer/repository_index.py::_path_module_keys` | function |  |
| `indexer/repository_index.py::_import_module_keys` | function |  |
...
| `indexer/repository_index.py::_snapshot_ref` | function |  |
...
| `indexer/repository_service.py::RepositoryService.reconcile_branches` | method |  |
...
| `indexer/repository_store.py::RepositoryStoreVersionError` | class |  |
...
| `indexer/repository_store.py::RepositoryStore.compact` | method | Return the number of freelist pages reclaimed from this index. |
| `indexer/repository_store.py::RepositoryStore._initialize` | method |  |
| `indexer/repository_store.py::_execute_statements` | function |  |
